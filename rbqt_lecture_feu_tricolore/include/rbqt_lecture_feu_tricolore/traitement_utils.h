#ifndef _RBQT_LECTURE_FEU_TRICOLORE__TRAITEMENT_UTILS__HEADER_
#define _RBQT_LECTURE_FEU_TRICOLORE__TRAITEMENT_UTILS__HEADER_
...
#endif // _RBQT_LECTURE_FEU_TRICOLORE__TRAITEMENT_UTILS__HEADER_